        ...
        <tbody>
            <?php foreach ($hesaplar as $hesap) : ?>
               <tr id="<?= $hesap['hesap_id']; ?>">
                    ...
                    <td><?= $hesap['sifre']; ?></td>
            <td>
        <a data-id="<?= $hesap['hesap_id']; ?>" class="btn btn-primary btnEdit">Düzenle</a>
        <a data-id="<?= $hesap['hesap_id']; ?>" class="btn btn-danger btnDelete">Sil</a>
    <?php
            // daire_id değerini al
            $daire_id = $hesap['daire_id'];
            // Profil sayfasına yönlendirme bağlantısı oluştur
            $profil_url = site_url('profil/' . $daire_id);
            ?>
            <a href="<?= $profil_url ?>" class="btn btn-info">Profil</a>
