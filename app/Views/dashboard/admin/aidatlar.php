...
<script>
    ...
    $(document).ready(function () {
        // Validation and AJAX code for adding and updating aidat records
        ...
        $("#addUser").validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    error: function (data) {
                        // Handle AJAX error
                        alert("An error occurred while adding the aidat.");
                    }
                });
            }
        });
        ...
        $('body').on('click', '.btnEdit', function () {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    $('#updateUser #txtOdemeTarihi').val(res.data.odeme_tarihi);
                    $('#updateUser #txttutar').val(res.data.tutar);
                },
                error: function (data) {
                    // Handle AJAX error
                    alert("An error occurred while fetching aidat details for editing.");
                }
            });
        });
        ...
        $("#updateUser").validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    error: function (data) {
                        // Handle AJAX error
                        alert("An error occurred while updating the aidat.");
                    }
                });
            }
        });
        ...
        $('body').on('click', '.btnDelete', function () {
            ...
            var confirmDelete = confirm("Aidat silinecek emin misiniz?");
            
            if (confirmDelete) {
                $.ajax({
                    url: 'aidatlar/delete/' + aidat_id,
                    type: "GET",
                    dataType: 'json',
                    success: function (res) {
                        if (res.status === true) {
                            ...
                            alert("Failed to delete the aidat.");
                        }
                    },
                    error: function (data) {
                        // Handle AJAX error
                        alert("An error occurred while deleting the aidat.");
                    }
                });
            }
        });
